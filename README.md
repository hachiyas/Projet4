...
In this report ,  we will execute  the various steps and procedures to overcome in order to create a proper spreadsheet with its own tools such as a **searching engine**
...
```
> After creating the interface / templates,  we will add the tools we discussed before.
...
```
>   we can find any cell only by typing the correct regular expression
...
```
> We can  search for any data inside our spreadsheet .

# Conclusion 

In this project we create a spreadsheet from scratch, making use of both **UI Widgets** and **Brute Coding** , and i am glad to learn and work on this project .
